...
function hunterslodge_customcolours_permanent_define_item(){
	...
	set_item_setting("context_village","true","hunterslodge_customcolours_permanent");
	set_item_setting("context_forest","true","hunterslodge_customcolours_permanent");
	set_item_setting("context_worldmap","true","hunterslodge_customcolours_permanent");
	set_item_setting("lodge_cost","595","hunterslodge_customcolours_permanent");
	set_item_setting("lodge_longdesc","This Name Colourisation Kit (IE a big pack of felt-tip pens) will allow you to add colour codes to your name. If you want a fancy, colourful name, then this is the item for you; you might want to check out the Title Change item, too.`n`nThis item lets you colourise your name as many times as you want, and as often as you want - but remember, `4only `bunused`b Name Colourisation Kits can be gifted to other players.`0`n`nYou can use this item in Jungles, while Travelling, in Outposts and in the Hunter's Lodge.","hunterslodge_customcolours_permanent");
...
function hunterslodge_customcolours_use($args){
	redirect("runmodule.php?module=hunterslodge_customcolours&op=change&context=".$args['context']);
}

function hunterslodge_customcolours_permanent_use($args){
	redirect("runmodule.php?module=hunterslodge_customcolours&op=change&free=1&context=".$args['context']);
}
