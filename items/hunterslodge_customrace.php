...
function hunterslodge_customrace_permanent_define_item(){
	...
	set_item_setting("lodge_cost","1000","hunterslodge_customrace_permanent");
...
function hunterslodge_customrace_use($args){
	redirect("runmodule.php?module=hunterslodge_customrace&op=change");
}

function hunterslodge_customrace_permanent_use($args){
	redirect("runmodule.php?module=hunterslodge_customrace&op=change&free=1");
}
