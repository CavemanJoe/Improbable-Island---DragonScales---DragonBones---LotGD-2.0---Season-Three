...
function hunterslodge_customweapon_define_item(){
	...
	set_item_setting("description","Useful for roleplayers, this item allows you to change the name of your weapon, shown in your character stats and commentary areas.","hunterslodge_customweapon");
...
function hunterslodge_customweapon_use($args){
	redirect("runmodule.php?module=hunterslodge_customweapon&op=change&context=".$args['context']);
}

function hunterslodge_customweapon_permanent_use($args){
	redirect("runmodule.php?module=hunterslodge_customweapon&op=change&free=1&context=".$args['context']);
}
