...
function hunterslodge_customweapon_permanent_define_item(){
	set_item_setting("allowtransfer","lodgebag","hunterslodge_customweapon_permanent");
	set_item_setting("blocktransfer","true","hunterslodge_customweapon_permanent");
	...
	set_item_setting("tradable","true","hunterslodge_customweapon_permanent");
	set_item_setting("type","normal","hunterslodge_customweapon_permanent");
