...
if (!httpget('r')){
	...
	$r=httpget('r');
	addnav("New to LoGD?");
	addnav("Create a character","create.php?r=".$r);
	addnav("Game Functions");
	addnav("Forgotten Password","create.php?op=forgot&r=".$r);
	addnav("List Warriors","list.php?r=".$r);
	addnav("Daily News", "news.php?r=".$r);
	addnav("Other Info");
