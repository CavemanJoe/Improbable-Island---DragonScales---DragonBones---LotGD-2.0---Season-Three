	...
	switch ($op){
		case "start":
			if (get_module_pref("visited") == 0){
				...
				if (!get_module_pref("able","timedcombat"){
					addnav("Tell me something I don't know.","runmodule.php?module=basictraining&op=somethingnew");
				}
		...
		case "continue":
			...
			iitems_give_item("backpack1");
			iitems_give_item("bandolier1");
			addnav("Questions");
		...
		case "travel":
			...
			break;
		case "somethingnew":
			output("The Corporal beams at you.  \"`2WELL NOW, young RECRUIT!  How about a STORY, eh?`0\"`n`nYou sigh.  \"`#Go on.`0\"`n`n\"`2ONCE upon a time, there was a CAVEMAN!`0\" bellows the Corporal, marching casually back and forth as he talks.  \"`2This CAVEMAN ran an online GAME that worked with a DATABASE!  His game ran very SLOWLY, so he had to OPTIMIZE it by MINIMISING the number of database queries.  But no matter WHAT the caveman did, it was all FUTILE because every time he speeded up his game, that just meant that people could play it FASTER!  AND!  THEY!  JOLLY!  WELL!  `iDID!`i`0\"  The Corporal takes a deep breath.  \"`2The DEMAND to play the game, and the speed at which people played it, was so HIGH that the caveman had to sit down and have a jolly good THINK about it!0\"  The Corporal sits down on the ground, with his 
			break;
		}
	page_footer();
}
