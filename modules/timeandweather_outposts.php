					...
					switch($stateinfo['timezone']){
						...
						case 6:
							...
							switch ($stateinfo['weather']){
								...
								break;
								case 5:
									$t = "The sun has gone to bed, and the sticky night air feels like a warm bowl of soup.  A few residents are engaged in conversation outside the Museum, despite the fine drizzle of rain.  You wonder why the Museum seems so attractive.";
								break;
								case 6:
