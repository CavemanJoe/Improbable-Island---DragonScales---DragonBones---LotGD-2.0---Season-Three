...
//<<<<<<< HEAD
			//I think this is for turns, so is commented out. If problems persistin this area, swap the coments bewtween this section and the next before thed end commit bit
			/*
