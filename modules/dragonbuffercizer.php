...
function dragonbuffercizer_dohook($hookname,$args){
	...
	case "buffdragon":
		...
		if($breathfire && e_rand(1, 100) < get_module_setting("firechance")){
			...
			apply_buff('improbably_burny_fire', array(
				"startmsg"=>"`n`^The Improbability Drive flickers for a moment as it changes reality.  When the Improbability energy has faded, you realise whta the Improbability Drive has changed - you're on fire!`n`n",
				"name"=>"`%Improbably Burny Fire",
				"rounds"=>30,
				"wearoff"=>"The Improbably Burny Fire appears to be extinguished.  The drive must be getting weak now.",
				"minioncount"=>1,
				"mingoodguydamage"=>0,
				"maxgoodguydamage"=>$maxfiredamage,
				"effectmsg"=>"`7You are engulfed in `4Improbably Burny fire`7 and take`4 {damage} `7damage.`0",
				"effectnodmgmsg"=>"`7You are engulfed in `4Improbably Burny fire`7 but take no damage.`0",
				"effectfailmsg"=>"`7Miraculously, the `4Improbably Burny fire`7 misses you.`0",
