...
function luggagehut_getmoduleinfo(){
	$info=array(
		"name"=>"Luggage Hut",
		"version"=>"2010-09-15",
...
function luggagehut_uninstall(){
	return true;
}

function luggagehut_dohook($hookname,$args){
	global $session;
	switch($hookname){
		case "village":
			...
			tlschema();
			addnav("The Luggage Hut","runmodule.php?module=luggagehut&op=start");
			break;
	}
	return $args;
}
